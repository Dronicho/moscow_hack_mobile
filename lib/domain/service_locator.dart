...
abstract class ServiceLocator {
  ...
  @visibleForTesting
  @protected
  void registerSingleton<T extends Object>(T instance, {DisposingFunc<T>? dispose}) {
  ...
  @visibleForTesting
  @protected
  void registerFactory<T extends Object>(ValueGetter<T> factoryFunc) => getIt.registerFactory(factoryFunc);
