  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    canvas.drawRRect(
        RRect.fromRectAndCorners(
          rect,
          bottomRight: Radius.circular(offset.dx > 100 ? 0 : bottomRightRadius),
          topRight: Radius.circular(offset.dx > 100 ? 0 : topRightRadius),
          bottomLeft: Radius.circular(offset.dx < 100 ? 0 : bottomLeftRadius),
          topLeft: Radius.circular(offset.dx < 100 ? 0 : topLeftRadius),
        ),
        paint);
  }
}
